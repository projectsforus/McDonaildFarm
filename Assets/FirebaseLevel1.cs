...
public class FirebaseLevel1 : MonoBehaviour
{ // InputField  ProgressIdication, currentLevel;
    ...
    {
        patients patients = new patients(PlayerPrefs.GetString("username"), PlayerPrefs.GetString("password"), PlayerPrefs.GetString("age"), PlayerPrefs.GetString("gender"), "1");
